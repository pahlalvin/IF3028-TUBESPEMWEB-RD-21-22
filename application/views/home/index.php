...
<p class="judul">SIMPLE LAPOR!</p>
 <div class="lapor">
    ...
    <a class="buat" href="<?php base_url(); ?>buat">Buat Laporan / Komentar &nbsp<img src="assets/icon/komentar.png" height="13px"></a>
    ...
    <br>
         ...
         <?php foreach ($home as $hm )  :?>
          ...
          <p><?php echo substr($hm['laporan'], 0, 450); ?></p>
              ...
              <?php
                ...
                <a class='more' href='detail?detail_id=$id'>Lihat Selengkapnya  &nbsp<img src='assets/icon/selengkapnya.png' height=13px></a>		
        ...
        <br>
        <?php endforeach; ?>
        <img class="gambar" src='assets/icon/awalmenu.png'
        <img class="gambar" src='assets/icon/awalmenu.png'
        <br>
